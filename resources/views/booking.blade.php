...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col input-group mb-3">
            ...
            <input type="number" class="form-control" value="{{ $datamobil->harga_sewa }}" disabled>
        </div>
        <div class="col input-group mb-3">
    ...
    <div class="row">
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="nama_lengkap" name="nama_lengkap" placeholder="Cth: Muhammad Rafi Dwi Putra">
            @error('nama_lengkap')
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="alamat_lengkap" name="alamat_lengkap" placeholder="Cth: Jl Pak Benceng GG morodadi V">
